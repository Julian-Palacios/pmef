...
for j in [1,2,5,10,20,50,100]:#Resuelve para 1, 2, ..., 100 Elementos Finitos
  ...
  print('Resolviendo...')
  u =spsolve(K.tocsr(),f)
  print("Desplazamiento vertical en (L,0)=\n",u[-1])
  ##
  ...
  VPs.append([j,vp1])
  print("Frecuencia del Modo 1: %s (Hz)"%vp1)
  ##
...
##
  ...
  ug=np.genfromtxt("./INPUT/Lima66NS15-35_dt0.01.txt")/100
  dt=0.01
...
##np.savetxt("./OUTPUT/Bernoulli_puntual.txt",despV,fmt="%10.7f")
##np.savetxt("./OUTPUT/Bernoulli_Modo1.txt",VPs,fmt="%10.7f")
##np.savetxt("./OUTPUT/Respuesta_Bern_Consis_Rayleigh.txt",np.array(resp).T)
